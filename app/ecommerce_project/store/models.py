...
class Car_brand(models.Model):
    """
    marcas de los automoviles que maneja la tienda ciChile
    """
    name = models.CharField(max_length=250, unique=True)
    image = models.ImageField(upload_to='car_brand', blank=True)
...
class Car_model(models.Model): 
    """
    modelos de autos que trabaja la tiendo ciChile  
    """
    name = models.CharField(max_length=250, unique=True)
    brand = models.ForeignKey(Car_brand, on_delete=models.CASCADE) # marca  del modelo!
    code = models.IntegerField()
...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE)
     #no soportado por sqlite3
    # compatible_models = models.JSONField(default='list')
